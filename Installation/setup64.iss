...
AppVerName=SphinxQt 1.0
AppVersion=1.0
DefaultDirName={pf}\SphinxQt
DefaultGroupName=SphinxQt
DisableWelcomePage=no
LicenseFile=license.txt
OutputBaseFilename=setup64
SetupIconFile=icon.ico
SignTool=signtool
UninstallDisplayIcon={app}\SphinxQt.exe,0
UninstallDisplayName=SphinxQt
...
Source: "SphinxQt.exe"; DestDir: "{app}"
...
[Icons]
Name: "{group}\SphinxQt"; Filename: "{app}\SphinxQt.exe";
Name: "{userdesktop}\SphinxQt"; Filename: "{app}\SphinxQt.exe"; Tasks: desktopicon
